<?php
/**
 * Adds the author meta for use in the Noor Theme Author box.
 *
 * Used in the Noor Theme
 *
 * @since 1.0.4
...
class Author_Meta {
	...
	public function extra_profile_fields( $user ) {
		if ( current_user_can( 'edit_posts' ) && current_user_can( 'edit_user', $user->ID ) ) {
			?>
			<?php wp_nonce_field( 'noor-profile-extras', 'noor-profile-nonce' ); ?>
			<h3><?php echo esc_html__( 'Extra profile information for author box', 'noor-starter-templates' ); ?></h3>
			<table class="form-table">
				<tr>
					<th>
						<label for="occupation">
							<?php esc_html_e( 'Occupation', 'noor-starter-templates' ); ?>
						</label>
					</th>
					<td>
						...
						<span class="description"><?php esc_html_e( 'Please enter your Occupation.', 'noor-starter-templates' ); ?></span>
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						...
						<span class="description"><?php esc_html_e( 'Please enter your Facebook url. (be sure to include https://)', 'noor-starter-templates' ); ?></span>
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						...
						<span class="description"><?php esc_html_e( 'Please enter your Twitter url. (be sure to include https://)', 'noor-starter-templates' ); ?></span>
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						...
						<span class="description"><?php esc_html_e( 'Please enter your Instagram url. (be sure to include https://)', 'noor-starter-templates' ); ?></span>
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						...
						<span class="description"><?php esc_html_e( 'Please enter your YouTube url. (be sure to include https://)', 'noor-starter-templates' ); ?></span>
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						...
						<span class="description"><?php esc_html_e( 'Please enter your Flickr url. (be sure to include https://)', 'noor-starter-templates' ); ?></span>
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						...
						<span class="description"><?php esc_html_e( 'Please enter your Vimeo url. (be sure to include https://)', 'noor-starter-templates' ); ?></span>
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						...
						<span class="description"><?php esc_html_e( 'Please enter your Linkedin url. (be sure to include https://)', 'noor-starter-templates' ); ?></span>
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						...
						<span class="description"><?php esc_html_e( 'Please enter your Dribbble url. (be sure to include https://)', 'noor-starter-templates' ); ?></span>
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						...
						<span class="description"><?php esc_html_e( 'Please enter your Pinterest url. (be sure to include https://)', 'noor-starter-templates' ); ?></span>
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						...
						<span class="description"><?php esc_html_e( 'Please enter your Amazon url. (be sure to include https://)', 'noor-starter-templates' ); ?></span>
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						...
						<span class="description"><?php esc_html_e( 'Please enter your Medium url. (be sure to include https://)', 'noor-starter-templates' ); ?></span>
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						...
						<span class="description"><?php esc_html_e( 'Please enter your Goodreads url. (be sure to include https://)', 'noor-starter-templates' ); ?></span>
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						...
						<span class="description"><?php esc_html_e( 'Please enter your BookBub url. (be sure to include https://)', 'noor-starter-templates' ); ?></span>
					</td>
				</tr>
			</table>
			<?php
	...
	public function save_extra_profile_fields( $user_id ) {
		...
		if ( ! isset( $_POST['noor-profile-nonce'] ) || ! wp_verify_nonce( sanitize_key( $_POST['noor-profile-nonce'] ), 'noor-profile-extras' ) ) {
			return;
		}
